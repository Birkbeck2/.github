...
For example, for 2024-25, the bird is `canary`. For an HTML contact form homework, you might name the assignment `canary-homework-06-contact-form`. This will result in student repositories with that as a prefix, such as `canary-homework-06-contact-form-joemull`.
